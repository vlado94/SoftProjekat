...
def putPictureInLeftCorner(img_BW) :
    ...
    try :
        ...
        widthOfNumber = maxy - miny
        #print "sirina objekta:"
        #print widthOfNumber
        heightOfNumber = maxx - minx
        #print "visina objekta:"
        #print heightOfNumber
        newImg [0 : heightOfNumber, 0 : widthOfNumber] = newImg [0 : heightOfNumber,0 : widthOfNumber] + img_BW[ minx : maxx, miny : maxy]
        return  newImg
    except  ValueError:
        print "uhvaceno"
        pass
